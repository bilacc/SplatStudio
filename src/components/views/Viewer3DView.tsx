...
import { OrbitControls, Box as BoxMesh, Environment, Grid } from '@react-three/drei';
    ...
    <div className="flex flex-col h-full relative">
      ...
      <div className="absolute top-4 left-4 z-10 flex gap-2">
        <div className="bg-black/60 backdrop-blur-md px-3 py-1.5 rounded-lg border border-white/10 text-[11px] flex gap-4 shadow-lg shadow-black/20">
          <span><strong className="text-blue-400 font-medium">SPLAT:</strong> {hasFinished ? '1.2M' : '0'}</span>
